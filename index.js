...
// Listen for photos sent to the bot and reply with file_id
bot.on('photo', (msg) => {
    const chatId = msg.chat.id;
    ...
    if (photo && photo.file_id) {
        ...
        bot.sendMessage(chatId, "Sorry, I could not read that photo.");
    }
});
